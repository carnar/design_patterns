...
class CommentFactoryTest extends PHPUnit_Framework_TestCase {
	...
	public function testACommentsHasAllItsComposingPArts()
	{
		$postId = 1;
        $commentAuthor = "Joe";
        $commentAuthorEmail = "joe@gmail.com";
        $commentSubject = "Joe Has an Opinion about the Repository Pattern";
        $commentBody = "I think it is a good idea to use the Repository "
        				. "Pattern to persist and retrieve objects.";
 
        $commentData = array($postId, $commentAuthor, $commentAuthorEmail, 
        					$commentSubject, $commentBody);
